...
/* harmony import */ var _modules_accordeon_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/accordeon.js */ "./js/modules/accordeon.js");
/* harmony import */ var _modules_load_text_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/load-text.js */ "./js/modules/load-text.js");
/* harmony import */ var _modules_load_text_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_modules_load_text_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _modules_smooth_scroll_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/smooth-scroll.js */ "./js/modules/smooth-scroll.js");
/* harmony import */ var _modules_smooth_scroll_js__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_modules_smooth_scroll_js__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _utils_validate_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./utils/validate.js */ "./js/utils/validate.js");
/* harmony import */ var _utils_validate_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_utils_validate_js__WEBPACK_IMPORTED_MODULE_5__);
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  // Modules
  // ---------------------------------
  Object(_modules_accordeon_js__WEBPACK_IMPORTED_MODULE_2__["initAccordeon"])();
...
/*!*********************************!*\
  !*** ./js/modules/accordeon.js ***!
  \*********************************/
/*! exports provided: initAccordeon */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initAccordeon", function() { return initAccordeon; });
var section = document.querySelectorAll('.accordion-section--opened');
var initAccordeon = function initAccordeon() {
  section.forEach(function (el) {
    return el.classList.remove('accordion-section--opened');
  });
  document.querySelectorAll('.accordion-section').forEach(function (el) {
    el.addEventListener('click', function (e) {
      document.querySelectorAll('.accordion-section').forEach(function (element) {
...
var textOpen = document.querySelector('.about-us__text-wrapper');
var button = document.querySelector('.about-us__button');
...
var form = document.querySelector('.form__user');
var formModal = document.querySelector('.modal__form');
var checkbox = form.querySelector('#agree');
var checkboxModal = formModal.querySelector('#agreement');
...
form.addEventListener('onsubmit', function (evt) {
  evt.preventDefault();
  invalid();
});
var invalidModal = function invalidModal() {
...
formModal.addEventListener('onsubmit', function (evt) {
  evt.preventDefault();
  invalidModal();
});
